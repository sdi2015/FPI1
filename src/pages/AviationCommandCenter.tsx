...
export function AviationCommandCenter() {
  ...
  return (
    <section className="aviation-command-center aviation-ops-command-center">
      <AviationHeaderSummary onPlanTrip={() => setActiveTab('planner')} onRunScan={handleScan} />
      {selectedAirport ? <AviationTripContextBar airport={selectedAirport} radiusMiles={radiusMiles} tripName={tripName} risk={risk} /> : null}
